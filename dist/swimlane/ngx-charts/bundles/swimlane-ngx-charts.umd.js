    ...
    ***************************************************************************** */
    ...
    var ChartComponent = /** @class */ (function () {
        function ChartComponent() {
            ...
            this.legendLabelToggle = new core.EventEmitter();
        }
    ...
    ChartComponent.propDecorators = {
        ...
        legendLabelToggle: [{ type: core.Output }]
    };
    ...
    var CircleSeriesComponent = /** @class */ (function () {
        ...
        CircleSeriesComponent.prototype.isHidden = function (entry) {
    ...
    var TooltipArea = /** @class */ (function () {
        ...
        TooltipArea.prototype.isHidden = function (tooltipItem) {
            if (!this.hiddenEntries)
                return false;
            var item = this.hiddenEntries.find(function (d) {
    ...
    var LegendComponent = /** @class */ (function () {
        function LegendComponent(cd) {
            ...
            this.labelToggle = new core.EventEmitter();
            this.legendEntries = [];
        }
        ...
        LegendComponent.prototype.toggle = function (item) {
     ...
     */
    function toggleEntry(item, hiddenEntries) {
        var hidden;
        var idx = hiddenEntries.findIndex(function (d) {
        ...
        return { hidden: hidden, hiddenEntries: __spread(hiddenEntries) };
    }
    ...
    var AreaChartComponent = /** @class */ (function (_super) {
        ...
        function AreaChartComponent() {
            ...
            _this.toggle = new core.EventEmitter();
        ...
        AreaChartComponent.prototype.onToggle = function (item) {
            if (!this.canHideSerie)
                return;
            var toggleResult = toggleEntry(item, this.hiddenEntries);
    ...
    var AreaChartNormalizedComponent = /** @class */ (function (_super) {
        ...
        AreaChartNormalizedComponent.prototype.onToggle = function (item) {
            if (!this.canHideSerie)
                return;
            var toggleResult = toggleEntry(item, this.hiddenEntries);
            this.hiddenEntries = toggleResult.hiddenEntries;
    ...
    var AreaChartStackedComponent = /** @class */ (function (_super) {
        ...
        AreaChartStackedComponent.prototype.onToggle = function (item) {
            if (!this.canHideSerie)
                return;
            var toggleResult = toggleEntry(item, this.hiddenEntries);
            this.hiddenEntries = toggleResult.hiddenEntries;
    ...
    var AreaSeriesComponent = /** @class */ (function () {
        ...
        AreaSeriesComponent.prototype.isHidden = function (entry) {
    ...
    var LineChartComponent = /** @class */ (function (_super) {
        ...
        LineChartComponent.prototype.onToggle = function (item) {
            if (!this.canHideSerie)
                return;
            var toggleResult = toggleEntry(item, this.hiddenEntries);
            this.hiddenEntries = toggleResult.hiddenEntries;
    ...
    var LineSeriesComponent = /** @class */ (function () {
        ...
        LineSeriesComponent.prototype.isHidden = function (entry) {
            if (!this.hiddenEntries || this.hiddenEntries.length === 0)
                return false;
            var item = this.hiddenEntries.find(function (d) {
                return entry.name === d.name;
